...
public:
    ...
    /* The three functions below are "pure virtual". Pure virtual
       functions are essentially placeholders that _must_ be overridden
       by subclasses. Any class with pure virtual functions is
       considered "incomplete" and therefore cannot be instantiated.

       Incomplete classes like this one are often called "abstract classes"
    */
